...
const translations: Record<AppLanguage, DictionaryNode> = {
  en: {
    ...
    pipelines: {
      ...
      import: {
        title: 'Data Import',
        subtitle: 'Managed batch upload with schema validation and error reporting.',
        validationOnly: 'Current step is validation-only: the batch is stored and checked, but is not pushed into MongoDB/Kafka yet.',
  ...
  ru: {
    ...
    pipelines: {
      ...
      import: {
        ...
        subtitle: 'Управляемая batch-загрузка с валидацией схемы и отчётом об ошибках.',
        validationOnly: 'Текущий шаг работает только как validation-layer: batch сохраняется и проверяется, но пока не отправляется дальше в MongoDB/Kafka.',
